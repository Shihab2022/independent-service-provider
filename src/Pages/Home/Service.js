...
const Service = () => {
  ...
  <div className="container lg:px-5  lg:py-14  mx-auto">
    <div className="flex flex-col text-center md:mt-0 mt-5 w-full mb-20">
      ...
      <h1 className='mt-5 text-4xl  font-bold underline hover:text-yellow-500 text-yellow-700'>My Service</h1>
    </div>
  <div className='grid md:grid-cols-2 lg:px-28 md:px-2 px-5  lg:gap-10 gap-5'>
  {
       serviceData.map(data =>  <ServiceDetails data={data} key={data.id}></ServiceDetails>)
