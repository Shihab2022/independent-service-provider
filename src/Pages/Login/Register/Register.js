...
const Register = () => {
  ...
  const [signInWithGoogle, googlLoading, googleError] =
  ...
  setUserError('Your password and confirm Password does not same .')
}
    e.preventDefault();
  };
        ...
        <div className="px-8 py-6  text-left rounded-lg bg-zinc-800 shadow-lg">
          ...
          <div className="flex  items-baseline justify-between">
            <button
              ...
              className="px-28 py-2 mt-4 text-white hover:bg-yellow-600 rounded-full bg-red-800"
            >
