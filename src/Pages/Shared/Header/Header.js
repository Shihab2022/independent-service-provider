...
const Header = () => {
  ...
  <img className="md:mb-0 mb-3" src={ headerLogo} alt="" />
    <nav className="md:ml-auto  flex flex-wrap items-center font-mono md:text-xl  justify-center">
      ...
      {
        user ? <button  onClick={LogOutUser} className='px-4 md:mt-0 mt-3 text-black py-2 rounded-full md:mr-5 bg-rose-700'>LogOut</button>
        :
        <Link to='/login' className='px-6 md:mt-0 mt-3 text-black py-2 rounded-full md:mr-5 bg-amber-300'>Login</Link>
        }
